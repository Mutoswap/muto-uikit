...
var Icon$P = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/dito/logo.png" })));
};
...
var Icon$K = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/dito/9.png" })));
};
...
var StyledAlert = styled(Flex)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: relative;\n  background-color: ", ";\n  border-radius: 16px;\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n"], ["\n  position: relative;\n  background-color: ", ";\n  border-radius: 16px;\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n"])), function (_a) {
    var theme = _a.theme;
    return theme.alert.background;
});
    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { size: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$V, { width: "24px", color: "currentColor" }))))));
};
var templateObject_1$F, templateObject_2$e, templateObject_3$7, templateObject_4$2;
...
var DefaultSeparator = React.createElement(Icon$X, { color: "currentColor", width: "24px" });
...
var Progress = function (_a) {
    ...
    return (React.createElement(StyledProgress, null,
        showProgressBunny && (React.createElement(ProgressBunnyWrapper, { style: { left: stepGuard(primaryStep) + "%" } },
            React.createElement(Icon$F, null))),
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/dito/9.png" })));
};
...
var templateObject_1$i, templateObject_2$8, templateObject_3$5, templateObject_4$1, templateObject_5$1;
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$V, { color: "primary" })))),
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 240 50" }, props),
        React.createElement("image", { width: "240", height: "50", href: isDark ? "/images/dito/LogoTextNewDark.png" : "/images/dito/LogoTextNewWhite.png" })));
};
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$1, null, links.map(function (entry) {
        var Icon = entry.icon ? Icons$1[entry.icon] : undefined;
        var iconElement = Icon ? React.createElement(Icon, { width: "24px", mr: "8px" }) : undefined;
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            cakePriceUsd ? (React.createElement(React.Fragment, null,
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$S, { width: "20px", color: "primary", ml: "4px" }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#6E491E", textDisabled: "#BDC2C4", textSubtle: "#185F5E", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
...
export { Icon$19 as AddIcon, Alert, Icon$18 as ArrowBackIcon, Icon$17 as ArrowDownIcon, Icon$16 as ArrowDropDownIcon, Icon$15 as ArrowDropUpIcon, Icon$14 as ArrowForwardIcon, Icon$13 as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$12 as BinanceIcon, Icon$1b as BlockIcon, Breadcrumbs, Icon$11 as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$$ as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$10 as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$1d as CheckmarkCircleIcon, Icon$_ as CheckmarkIcon, Icon$Z as ChevronDownIcon, Icon$Y as ChevronLeftIcon, Icon$X as ChevronRightIcon, Icon$W as ChevronUpIcon, Icon$V as CloseIcon, Icon$U as CogIcon, Icon$T as CommunityIcon, Icon$S as CopyIcon, CopyToClipboard, Dropdown, Icon$1c as ErrorIcon, Flex, Icon$J as GooseRoundIcon, Heading, Icon$R as HelpIcon, IconButton, Image, Icon$1a as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$Q as ListViewIcon, Icon$P as LogoIcon, Icon$O as LogoRoundIcon, Menu, Icon$N as MinusIcon, Modal, ModalProvider, Icon$M as OpenNewIcon, Icon$K as PancakeRoundIcon, Icon$L as PancakesIcon, Icon$I as PrizeIcon, Progress, Icon$F as ProgressBunny, Radio, Icon$H as RemoveIcon, ResetCSS, Icon$B as SearchIcon, Skeleton, Spinner, Svg, Icon$A as SwapVertIcon, Icon$z as SyncAltIcon, Tag, Text, Icon$D as Ticket, Icon$C as TicketRound, ToastContainer, Toggle, Icon$G as VerifiedIcon, Icon$y as WarningIcon, Icon$E as Won, variants as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
