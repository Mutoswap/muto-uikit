...
var Icon$P = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/dito/logo.png" })));
};
...
var Icon$K = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/dito/9.png" })));
};
...
var StyledAlert = styled__default['default'](Flex)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: relative;\n  background-color: ", ";\n  border-radius: 16px;\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n"], ["\n  position: relative;\n  background-color: ", ";\n  border-radius: 16px;\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n"])), function (_a) {
    var theme = _a.theme;
    return theme.alert.background;
});
...
var DefaultSeparator = React__default['default'].createElement(Icon$X, { color: "currentColor", width: "24px" });
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/dito/9.png" })));
};
    ...
    return (React__default['default'].createElement(StyledModal, null,
        React__default['default'].createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default['default'].createElement(Icon$V, { color: "primary" })))),
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 240 50" }, props),
        React__default['default'].createElement("image", { width: "240", height: "50", href: isDark ? "/images/dito/LogoTextNewDark.png" : "/images/dito/LogoTextNewWhite.png" })));
};
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$1, null, links.map(function (entry) {
        ...
        var iconElement = Icon ? React__default['default'].createElement(Icon, { width: "24px", mr: "8px" }) : undefined;
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null,
            cakePriceUsd ? (React__default['default'].createElement(React__default['default'].Fragment, null,
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$S, { width: "20px", color: "primary", ml: "4px" }),
...
exports.AddIcon = Icon$19;
exports.Alert = Alert;
exports.ArrowBackIcon = Icon$18;
exports.ArrowDownIcon = Icon$17;
exports.ArrowDropDownIcon = Icon$16;
exports.ArrowDropUpIcon = Icon$15;
exports.ArrowForwardIcon = Icon$14;
exports.AutoRenewIcon = Icon$13;
exports.BackgroundImage = BackgroundImage;
exports.BaseLayout = GridLayout$1;
exports.BinanceIcon = Icon$12;
exports.BlockIcon = Icon$1b;
exports.Breadcrumbs = Breadcrumbs;
exports.BunnyPlaceholderIcon = Icon$11;
exports.Button = Button;
exports.ButtonMenu = ButtonMenu;
exports.ButtonMenuItem = ButtonMenuItem;
exports.CalculateIcon = Icon$$;
exports.Card = Card;
exports.CardBody = CardBody;
exports.CardFooter = CardFooter;
exports.CardHeader = CardHeader;
exports.CardRibbon = CardRibbon;
exports.CardViewIcon = Icon$10;
exports.CardsLayout = GridLayout;
exports.Checkbox = Checkbox;
exports.CheckmarkCircleIcon = Icon$1d;
exports.CheckmarkIcon = Icon$_;
exports.ChevronDownIcon = Icon$Z;
exports.ChevronLeftIcon = Icon$Y;
exports.ChevronRightIcon = Icon$X;
exports.ChevronUpIcon = Icon$W;
exports.CloseIcon = Icon$V;
exports.CogIcon = Icon$U;
exports.CommunityIcon = Icon$T;
exports.CopyIcon = Icon$S;
exports.CopyToClipboard = CopyToClipboard;
exports.Dropdown = Dropdown;
exports.ErrorIcon = Icon$1c;
exports.Flex = Flex;
exports.GooseRoundIcon = Icon$J;
exports.Heading = Heading;
exports.HelpIcon = Icon$R;
exports.IconButton = IconButton;
exports.Image = Image;
exports.InfoIcon = Icon$1a;
exports.Input = Input$1;
exports.Link = Link;
exports.LinkExternal = LinkExternal;
exports.ListViewIcon = Icon$Q;
exports.LogoIcon = Icon$P;
exports.LogoRoundIcon = Icon$O;
exports.Menu = Menu;
exports.MinusIcon = Icon$N;
exports.Modal = Modal;
exports.ModalProvider = ModalProvider;
exports.OpenNewIcon = Icon$M;
exports.PancakeRoundIcon = Icon$K;
exports.PancakesIcon = Icon$L;
exports.PrizeIcon = Icon$I;
exports.Progress = Progress;
exports.ProgressBunny = Icon$F;
exports.Radio = Radio;
exports.RemoveIcon = Icon$H;
